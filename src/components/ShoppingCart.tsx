                                    ...
                                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                        ...
                                        <div className="border-t border-gray-200 py-2 px-4 ">
                                            ...
                                            <div className="mt-3">
                                                <a
                                                    href="#"
                                                    className="flex items-center justify-center rounded-md border border-transparent bg-black px-2 py-1 text-base font-medium text-white shadow-sm hover:drop-shadow-2xl "
                                                >
                                                    Checkout
                                                </a>
                                            </div>
